...
This second screening was done by looking into the full-text of each paper, here another 44 papers were excluded for the following reasons: wrong focus ($n = 29$), wrong population ($n = 7$), wrong study design ($n = 6$), wrong publication type ($n = 2$) - an overview of this can be found in the PRISMA flowchart [@haddawayPRISMA2020PackageShiny2022] in Figure \ref{fig:prisma}.
In the end, 32 papers were included in this review, $n = 8$ for hypothesis 1, $n = 9$ for hypothesis 2, and $n = 18$ for hypothesis 3 - some were used for multiple hypotheses. Out of the 516 papers, 381 were excluded for 'wrong focus', 73 for 'wrong population', 40 for 'wrong study design', 13 for wrong publication type, 4 for 'foreign language', and 1 for 'wrong study duration' (some papers were excluded for multiple reasons). A full list of all papers found and excluded can be found in the GitHub repository.  
