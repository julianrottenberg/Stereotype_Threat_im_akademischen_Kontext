...
\section{\texorpdfstring{\textbf{IMPORTANT NOTE: PUT AS FOOTNOTE! }}{IMPORTANT NOTE: PUT AS FOOTNOTE! }}\label{important-note-put-as-footnote}

\section{\texorpdfstring{\textbf{UNCLEAR WHETHER OR NOT THE PAPER FITS THE INCLUSION/EXCLUSION CRITERIA. }}{UNCLEAR WHETHER OR NOT THE PAPER FITS THE INCLUSION/EXCLUSION CRITERIA. }}\label{unclear-whether-or-not-the-paper-fits-the-inclusionexclusion-criteria.}

\section{\texorpdfstring{\textbf{DESCRIPTION OF THE PARTICIPANTS IS TOO VAGUE!}}{DESCRIPTION OF THE PARTICIPANTS IS TOO VAGUE!}}\label{description-of-the-participants-is-too-vague}

\section{\texorpdfstring{\textbf{EVERYTHING ELSE FITS THE INCLUSION/EXCLUSION CRITERIA SET BY THE PREREGISTRATION SO IT IS INCLUDED ANYWAYS }}{EVERYTHING ELSE FITS THE INCLUSION/EXCLUSION CRITERIA SET BY THE PREREGISTRATION SO IT IS INCLUDED ANYWAYS }}\label{everything-else-fits-the-inclusionexclusion-criteria-set-by-the-preregistration-so-it-is-included-anyways}
