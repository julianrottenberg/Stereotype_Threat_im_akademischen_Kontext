...
\item
  there were talking about ``young adults'', now we only have females. -\textgreater{} low to medium
\end{itemize}
...
- age -\textgreater{} a
- gender -\textgreater{} a
- OSPAN task (Operation Span Task) -\textgreater{} b
- Stereotype threat priming -\textgreater{} b
...
- Although we had thought that proactive TRI might be beneficial for task performance, proactive TRI was \emph{not} positively correlated with math verification accuracy in either the control condition or the stereotype threat primed condition.
...
- Contrary to our initial hypothesis, threat participants did \emph{not} have worse math verification accuracy than control participants.
