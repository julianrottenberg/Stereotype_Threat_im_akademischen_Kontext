...
\item
  ...
  -\textgreater{} switching
  -\textgreater{} clustering
  -\textgreater{} errors
  -\textgreater{} number of correct words
\end{itemize}
...
\item
  ...
  -\textgreater{} blatant vs moderately explicit vs sublte vs no activation
\end{itemize}
...
-\textgreater{} consisted of 3 parts: test instructions, sample item, and test items
-\textgreater{} experimenter took notes of the words generated
...
\item[$\square$]
  Details
\item
  Gender stereotype-activation cues -\textgreater{} b
\item
  Letter fluency performance -\textgreater{} b
\item
  Gender-stereotype questionnaire -\textgreater{} b
\item
  Self-rating -\textgreater{} b
\item
...
\emph{Gender-stereotype Questionnaire and Self-rating}:
- The mean probability estimate from the male column across all participants was M = 46.16 (SD = 12.74) and differed significantly from a value of 50, t(167) = -3.91, p \textless{} 0.0d, d = 0.30, indicating that in general, participants held a gender stereotype favouring women.
...
\emph{Correlations between Total Correct Words, Total Errors, Mean Cluster Size, Number of Switches, Gender-stereotype Score, and Self-rating Score}:
