...
\item[$\square$]
  Details
\item
  Identification with math, response on a Likert scale -\textgreater{} a
\item
  fMRI data -\textgreater{} b
\item
  math performance (math event data) -\textgreater{} b
\item
  stereotype threat -\textgreater{} b
\end{itemize}
...
\emph{Reaction Times}: The mean log reaction times for each participant were then analyzed in a mixed-model ANOVA patterned after the analysis of overall performance. This ANOVA revealed a main effect of time, and no interaction.\\
...
\item[$\boxtimes$]
  No (please specify)
\item
  The age is missing as well as recruiting methods and the course they were taking. As Jończyk et al. (2022) noted, women majoring in fields that are mostly studied by men might be more resilient or have higher coping mechanisms, thus the course and age of the sample might actually end up being essential to know.
\end{itemize}
...
\item
  see Jończyk et al. (2022) for examples of potential bias.
\end{itemize}
