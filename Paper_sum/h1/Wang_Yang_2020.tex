...
\urlstyle{same}
\hypersetup{
  pdftitle={Wang and Yang (2020)},
  pdflang={en-EN},
  pdfkeywords={keywords},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Wang and Yang (2020)}
\author{\phantom{0}}
\date{}


\shorttitle{Wang and Yang (2020)}
...
\bibitem[\citeproctext]{ref-wangEffectsPovertyStereotype2020}
Wang, S., \& Yang, D. (2020). The effects of poverty stereotype threat on inhibition ability in individuals from different income-level families. \emph{Brain and Behavior}, \emph{10}(12), e01770. \url{https://doi.org/10.1002/brb3.1770}
