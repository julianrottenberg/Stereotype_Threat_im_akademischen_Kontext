...
\item[$\square$]
  Not stated/unclear (please specify)
\item
  creativity -\textgreater{} fluency and originality
\item
  alpha power
\end{itemize}
...
It is the exact sample the authors wanted to get -\textgreater{} female undergraduate students in engineering.
...
\item
  Creative thinking tasks (fluency and originality) -\textgreater{} specifically Alternate Uses task (AUT) and Utopian Situations task (UST)
\end{itemize}
...
EEG -\textgreater{} alpha power\\
AUT and UST -\textgreater{} fluency and originality\\
demographic data
