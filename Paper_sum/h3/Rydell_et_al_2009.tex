...
\tightlist
\item
  seated at a computer in a private room
\item
  received instructions to manipulate the availability of stereotypes for college students and women regarding maths performance
\item
  completed a working memory task
\item
...
\item[$\square$]
  Details
\item
  demographics -\textgreater{} a
\item
  maths problem performance -\textgreater{} b
\item
  stereotype threat manipulation -\textgreater{} b
\item
  Working memory task performance -\textgreater{} b
\end{itemize}
