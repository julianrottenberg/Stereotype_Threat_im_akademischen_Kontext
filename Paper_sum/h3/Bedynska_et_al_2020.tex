...
\tightlist
\item
  parents and boys provided written consent
\end{enumerate}
...
\tightlist
\item
  After describing the purpose of the study and explaining the procedure, children opened a web browser to solve a working memory test and fill out online questionnaires
\end{enumerate}
...
\item
  ...
  -\textgreater{} there were 231 first-class studnets (M = 14.55 years, SD = 0.42)
  -\textgreater{} 204 second-class students (M = 15.5 years, SD = 0.37)
  -\textgreater{} 184 third-class students (M = 16.54 years, SD = 0.38)
\end{itemize}
...
\item[$\square$]
  Details
\item
  demographic data -\textgreater{} a
\item
  Grade Point Average (GPA) -\textgreater{} b
\item
  Working Memory Test -\textgreater{} b
\item
  Intellectual Helplessness Scale -\textgreater{} b
\item
  Chronic Stereotype Threat Scale -\textgreater{} b
\item
  gender identification -\textgreater{} b
\item
  language achievement -\textgreater{} b
\item
  domain identification -\textgreater{} b
\end{itemize}
...
\item
  Language achievement -\textgreater{} GPA from two semesters before the study
\item
  Intellectual helplessness -\textgreater{} 9-item Likert type scale, Items from Intellectual Helplessness Scale (IHS; Sedek \& McIntosh, 1998)
\item
  Working memory capacity -\textgreater{} functional aspects of working memory test (Sedek, Krejtz, Rydzewska, Kaczan, \& Rycielski, 2016). Consisted of three tasks, counting span task, set switching task, a spatial location memory task.
\item
...
\emph{Moderated model with working memory and intellectual helplessness as mediators}:
