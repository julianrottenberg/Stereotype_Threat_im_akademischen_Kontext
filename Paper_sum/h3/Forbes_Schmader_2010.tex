...
\textbf{Study 1}:
- Maths motivation -\textgreater{} b
- Working memory capacity -\textgreater{} b
- Maths performance -\textgreater{} b
- maths identification -\textgreater{} a

\textbf{Study 4}:
- demographic questionnaire -\textgreater{} a and b (due to the stereotype threat manipulation)
- working memory capacity -\textgreater{} b
- maths test -\textgreater{} b
