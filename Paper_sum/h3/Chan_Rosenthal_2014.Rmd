...
- Examine the moderating role of working memory on gender-maths stereotype threat.  

### What is/are the population focus/foci of the study?

- adolescents from Hong Kong.
...
- We expected typical stereotype threat effects, such that female adolescents in the threat condition would underperform compared to female adolescents in the control condition, and male adolescents in the threat condition.
- We expected high WM females in the threat condition to outperform low WM females in the threat conditoin
- We expected no difference between low and high WM females in the control condition, and no difference between low and high WM males in either condition.  
...
- Working memory (high vs low)
- Stereotype threat (threat vs control)
- gender 
...
- Those in the threat condition were told that mathematics ability can be affected by many personal factors, including gender, and that the purpose of the mathematics test was to evaluate how different factors such as gender relate to mathematics performance. They were informed that the scores for male and female students would be compared and were asked to put effort into the mathematics test
- For those in the control condition, gender was not mentioned. Instead participants were told that the aim of the study was to examine the reliability of the mathematics test, to establish whether the mathematics test was too easy or too difficult for Year 10 students. They were also asked to put effort into the mathematics test.  
...
1. Allocation in two groups
2. Working memory test
3. Stereotype threat manipulation vs no manipulation
4. Math test
...
- adolescents from Hong Kong under gender-maths stereotype threat  
...
- it is stated that all participants were studying mathematics and passed their previous school mathematics test.  
...
- Seventy (N = 70, 33 male; 37 female) Year 10 students (M = 15.54, SD = 0.58) were recruited from a secondary school in Hong Kong.  
...
- Working memory: A modified version of the reading span task (Robert, Borella, Fagot, Lecerf, & De Ribaupierre, 2009) assessed WM capacity.  
- Mathematics test: twenty-one questions were extracted from an English-language version of a Hong Kong Certificate of Education Examination past paper (Hong Kong Exam Authority), the questions were multiple choice with either 4 or 5 answer choices.
- Demographics: Demographic information was also collected  
...
- A gender x condition (threat, control) ANOVA
- Bonferroni-adjusted comparisons  

Moderating role of working memory:
- For the moderation analysis, gender was dummy coded and WM was mean-centred prior to analysis
- A gender x WM x condition moderated regression on mathematics performance was conducted.
- Threat condition: Moderated regression tested whether WM moderated mathematics performance. A gender x WM interaction variable was created. Additional simple slopes analysis was conducted.  
...
**Mathematics performance**:
- There was a significant effect of gender with adolescent males performing better than adolescent famles.
- The main effect for condition was also significant
- Performance in the control condition was significantly better than in the threat condition
- The significant gender x condition interaction was explored further
- Bonferroni-adjusted comparisons revealed a significant difference between males and females in the threat condition but no significant differences between males and females in the control condition
- This suggests that stereotype threat was experiences by adolescent females in the threat condition.
- There was a significant difference between the two conditions for females with underperformance in the threat condition compared to the control condition.
- There was no significant difference between the two conditions for males.  

**Moderating role of working memory**:
- Considering the difference in number of questions and age range, this is comparable to the findings of Robert et al. (2009)
- An initial gender x WM x condition moderated regression on mathematics performance was non-significant

*Threat condition*:
- At step 1, gender was significant with females underperforming compared to males: however, the effect of WM was non-significant
- At step 2, the gender x WM interaction variable was significant
- Through additional analysis we explored this significant interaction further and revealed that WM did not significantly predict mathematics performance for male adolescents
- WM did significantly predict mathematics performance for female adolescents; as WM increased, so too did mathematics performance
- Additional simple slopes analysis revealed a significant difference in mathematics performance for male and female adolescents with low WM, with low WM females underperforming compared to low WM males
- There was no significant difference between the genders of high WM.  
...
When female adolescents were informed that their scores would be compared to male adolescents, they underperformed compared to male adolescents in the same condition and female adolescents in the control condition. This suggests that the gender-mathematics stereotype exists in Hong Kong, and is capable of affecting performance. In addition, we established WM capacity as a moderator of stereotype threat.  
In line with Régner et al. (2010), low WM female adolescents underperformed compared to high WM females in the experimental condition. This suggests that low WM females were affected by stereotype threat, while high WM females were not. In contrast, no such effect was found in the control condition.  
High WM female adolescents were able to overcome stereotype threat, so that that their performance surpassed the performance of low WM females.  


We established stereotype threat effects for adolescent females taking a mathematics test in Hong Kong. This confirms that stereotype threat can occur for the gender-mathematics stereotype in an Asian nation. Crucially, we found that WM moderates this effect, such that low WM females experienced stereotype threat, while high WM females were protected.  `
...
- No mention of consent sought, no mention of ethical approval, no mention of funding.  
...
- Did not test how difficult the test were. 
