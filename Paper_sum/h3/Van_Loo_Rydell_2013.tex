...
\tightlist
\item
  learn how to solve MA problems
\item
  complete the ostensibly unrealted essay power manipulation, the power manipulation check, and the PANAS
\item
  same ST manipulation used in Experiment 1 and 2
\item
  instructions for the working memory task
\item
  working memory task
\item
  36 difficult MA problems
\item
  TBC measure
\end{enumerate}
...
- We did not expect a main effect of ST on feelings of power; however, this main effect is difficult to interpret as the power manipulation check was completed \emph{before} the manipulation of stereotype threat
...
- This main effect is difficult to interpret as the measure of mood was completed \emph{before} the manipulation of stereotype threat
