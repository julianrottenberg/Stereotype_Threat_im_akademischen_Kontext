...
The authors report Cronbach's alpha values for the chronic stereotype threat scale (α = .88) and intellectual helplessness scale (α = .90).
...
- Working memory mediated the relationship between stereotype threat and language achievement (γ = 0.45, 95% CI [0.34, 0.55])
- Intellectual helplessness mediated the relationships between stereotype threat and both achievement (γ = -0.13, 95% CI [-0.21, -0.06]) and domain identification (γ = -0.13, 95% CI [-0.22, -0.04])
