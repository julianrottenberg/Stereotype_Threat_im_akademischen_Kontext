...
- to determine if stereotype threat is limited to either low- or high-WM individuals
...
- We thought that women might experience stereotype threat in this domain. 
- The question is whether women with a high WM capacity are more able than their low-WM counterparts to resist stereotype threat.  
...
- "diagnostic" of logical reasoning ability (stereotype threat) vs. "diagnostic but gender fair (control)  
...
1. reading span task
2. Raven's Advanced Progressive Martices, were told that the test was either "diagnostic" of logical reasoning ability or "diagnostic but gender fair"  
...
- Individuals under stereotype threat in a domain they are highly identified with.  
...
- outstanding students in their last or second-to-last year (out of 5 years) at highly selective engineering schools.  
...
- 117 fourth- and fifth-year French engineering students (64 males, 53 females; mean age = 21 years, SD = 1.54 years).
...
- French version of the reason span task (Desmette, Hupet, Schelstraete, & van der Linden, 1995)
- Reasoning ability was assessed using Raven's Advanced Progressive Matrices (Raven, Raven, & Court, 1998)  
...
- regression analysis on gender, threat, WM, and their interactions
- simple slopes for low and high WM capacities 
...
- WM effect was significant
- the classic Gender x Threat interaction was significant and moderate by WM
- stereotype threat pattern occurred only among low-WM students 
- low-WM women underperformed relative to low-WM men when participants were told that the test was diagnostic, they performed as well as men when participants were told that the test was diagnostic but gender fair
- low-WM women in the gender-fair condition outperformed those in the diagnostic condition
- This stereotype threat pattern did not emerge among high-WM students, who performed at equally high levels in all conditions
- Controlling for participants' prior performance on standard tests of maths and physics (using scores taken from school records) did not change the findings.  
...
- The fact that high-WM women resisted stereotype threat is the first direct evidence that stereotype threat differs from choking under pressure, perhaps because the performance focus is different in the two cases (the focus in stereotype threat is on failure expectations, whereas the focus on choking is on pressure to succeed)
- Because Raven's task rules out the use of routines, stereotype threat cannot be attributed to the pernicious effect of allocating attention to automated processes
- Availability of fewer WM resources is a more likely explanations of our findings, becasue success on this task relies heavilty on WM capacity
- Our findings thus indicate that stigmatized individuals who excel academically may or may not experience stereotype threat, depending on WM availability.  
...
- no mention of consent or ethical approval.  
