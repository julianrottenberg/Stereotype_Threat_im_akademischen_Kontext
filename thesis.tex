...
This second screening was done by looking into the full-text of each paper, here another 47 papers were excluded for the following reasons: wrong focus (\(n = 29\)), wrong study design (\(n = 9\)), wrong population (\(n = 7\)), wrong publication type (\(n = 2\)) - an overview of this can be found in the PRISMA flowchart (Haddaway et al., 2022) in Figure \ref{fig:prisma}.
