...
Further, Experiment 1's results for the Stroop task, were replicated,\emph{F}(1, 101)=2.80, \emph{p}\textless0.10, \(\eta^{2}_{\text{p}}\)=0.03, and an interaction on Stroop inferences using a 2 \(\times\) 3 ANOVA were found, \emph{F}(2,101)=3.07, \emph{p}=.050, \(\eta^{2}_{\text{p}}\)=0.06).
