...
# Debugging: Check the number of rows in each part
left_rows <- nrow(abbreviations[1:midpoint,])
right_rows <- nrow(abbreviations[(midpoint+1):nrow(abbreviations),])

cat("Total rows: ", total_rows, "\n")
cat("Left content rows: ", left_rows, "\n")
cat("Right content rows: ", right_rows, "\n")
# Write to files
...
The Mental-Rotation-Task-3D showed a significant main effect of Sex, with men performing better than women, *F*(1,128) = `r apa_num(10.97)`, *p* = `r apa_p(.001)`, $\eta^{2}$ = `r apa_num(.08)`, *d* = `r apa_num(0.57)`, while Condition showed a significant main effect in the MP-2D, *F*(1,128) = `r apa_num(4.70)`, *p* = `r apa_p(.032)`, $\eta^{2}$ = `r apa_num(.04)`.
